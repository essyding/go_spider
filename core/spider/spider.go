...
import (
	...
	"github.com/essyding/go_spider/core/common/mlog"
	...
	"github.com/essyding/go_spider/core/common/resource_manage"
	"github.com/essyding/go_spider/core/downloader"
	"github.com/essyding/go_spider/core/page_processor"
...
func NewSpider(pageinst page_processor.PageProcessor, taskname string) *Spider {
	mlog.StraceInst().Open()

	ap := &Spider{taskname: taskname, pPageProcessor: pageinst}
